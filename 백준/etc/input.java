...
public class input {
    public static void main(String[] args) throws IOException {
        ...
        */
         ...
         *   3 4
         */
        int[][] ls2 = br.lines().takeWhile(l -> !l.isEmpty()).map(l -> Arrays.stream(l.split(" ")).mapToInt(Integer::parseInt).toArray()).toArray(int[][] :: new);
         ...
         *   2
         */
        int[] ls3 = br.lines().takeWhile(l -> !l.isEmpty()).mapToInt(Integer::parseInt).toArray();
    }
